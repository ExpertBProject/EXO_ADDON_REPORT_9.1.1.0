...
Public Class EXO_ADDON
    ...
    Public Function SBOApp_MenuEvent(ByVal infoEvento As MenuEvent) As Boolean
        ...
        End Try
    End Function
    Public Function CargarFormADDON() As Boolean
        Dim oForm As SAPbouiCOM.Form = Nothing
        ...
        Try
            ...
            oFP.XmlData = objGlobal.leerEmbebido(Me.GetType(), "EXO_ADDON.srf")
            ...
            CType(oForm.Items.Item("cb_Format").Specific, SAPbouiCOM.ComboBox).Select("10.Dll_64", BoSearchKey.psk_ByValue)
            CType(oForm.Items.Item("txt_Fich").Specific, SAPbouiCOM.EditText).Item.Enabled = False
            oForm.Visible = True

            CargarFormADDON = True
